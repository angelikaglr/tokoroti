...
<html>
<head>
	<title>Angel Cake Backery</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i>082170811334</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i>angelikagloriass@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Angel Cake Bakery Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>Angel CAKE BAKERY</b></a>
			</div>
